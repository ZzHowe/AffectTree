...
class RayPPOTrainer:
    ...
    def _validate(self) -> dict[str, Any]:
        ...
        for batch_dict in self.val_dataloader:
            ...
            test_gen_batch = test_batch.pop(
                ...
                non_tensor_batch_keys=["raw_prompt_ids", "multi_modal_data","messages","video_path","root_node","uid"],
            )
    ...
    def _make_batch_data(self, metrics: dict[str, Any]) -> DataProto:
        ...
        while True:
            ...
            cache_uids = copy.copy(new_batch.non_tensor_batch["uid"])
            gen_batch = new_batch.pop(
                batch_keys=["input_ids", "attention_mask", "position_ids"],
                non_tensor_batch_keys=["raw_prompt_ids", "multi_modal_data", "uid","messages","root_node","video_path"],
            ...
            new_batch = new_batch.repeat_uid(raw_uid_list = cache_uids,uid_list = uid_list, interleave=True)
            new_batch = new_batch.union(gen_batch_output)
